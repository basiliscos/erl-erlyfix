...
fields_test() ->
    ...
    ok = erlyfix_fields:validate(<<"USD">>, F_ContAmtCurr),
    error = erlyfix_fields:validate(<<"USDJPY">>, F_ContAmtCurr),
    error = erlyfix_fields:validate(<<"">>, F_ContAmtCurr),
    <<"USD">> = erlyfix_fields:convert(<<"USD">>, F_ContAmtCurr),

    % BOOLEAN
    {ok, F_PossDupFlag} = erlyfix_protocol:lookup(P, {field, by_name, 'PossDupFlag' }),
    ok = erlyfix_fields:validate(<<"Y">>, F_PossDupFlag),
    ok = erlyfix_fields:validate(<<"N">>, F_PossDupFlag),
    error = erlyfix_fields:validate(<<"n">>, F_PossDupFlag),
    ...
    ok = erlyfix_fields:validate(<<"BY">>, F_Country),
    error = erlyfix_fields:validate(<<"BYN">>, F_Country),
    <<"BY">> = erlyfix_fields:convert(<<"BY">>, F_Country),

    % UTCTIMEONLY
    {ok, F_MDEntryTime} = erlyfix_protocol:lookup(P, {field, by_name, 'MDEntryTime' }),
    ok = erlyfix_fields:validate(<<"11:12:55">>, F_MDEntryTime),
    ok = erlyfix_fields:validate(<<"11:12:55.123">>, F_MDEntryTime),
    error = erlyfix_fields:validate(<<"25:12:55">>, F_MDEntryTime),
    error = erlyfix_fields:validate(<<"11:62:55">>, F_MDEntryTime),
    error = erlyfix_fields:validate(<<"11:12:65">>, F_MDEntryTime),
    error = erlyfix_fields:validate(<<"11:12:55.1244">>, F_MDEntryTime),
    ?assertEqual(
    ...
    ok = erlyfix_fields:validate(<<"199812">>, F_MaturityMonthYear),
    ok = erlyfix_fields:validate(<<"19981210">>, F_MaturityMonthYear),
    ok = erlyfix_fields:validate(<<"199812w1">>, F_MaturityMonthYear),
    ok = erlyfix_fields:validate(<<"199812w5">>, F_MaturityMonthYear),
    error = erlyfix_fields:validate(<<"19981232">>, F_MaturityMonthYear),
    error = erlyfix_fields:validate(<<"199812w7">>, F_MaturityMonthYear),
    error = erlyfix_fields:validate(<<"garbage">>, F_MaturityMonthYear),
    ?assertEqual(
    ...
    ok = erlyfix_fields:validate(<<"19981231">>, F_IssueDate),
    error = erlyfix_fields:validate(<<"199812">>, F_IssueDate),
    error = erlyfix_fields:validate(<<"19981231111">>, F_IssueDate),
    ?assertEqual(
    ...
    ok = erlyfix_fields:validate(<<"19981231-23:59:59">>, F_LastUpdateTime),
    ok = erlyfix_fields:validate(<<"19981231-23:59:59.123">>, F_LastUpdateTime),
    error = erlyfix_fields:validate(<<"1998123123:59:59.123">>, F_LastUpdateTime),
    error = erlyfix_fields:validate(<<"1998123123:59:59.1231">>, F_LastUpdateTime),
    error = erlyfix_fields:validate(<<"garbage">>, F_LastUpdateTime),
    ?assertEqual(
        #utc_timestamp {
    ...
    ok = erlyfix_fields:validate(<<"123">>, F_LegRepurchaseRate),
