...
serialization_Logon_test() ->
    ...
    M_expected = <<"8=FIX.4.4", 1, "9=83", 1, "35=A", 1, "49=From-me", 1, "56=To-you", 1,
        "34=1", 1, "52=20090107-18:15:16", 1, "98=0", 1, "553=Login", 1,
        "554=Pass", 1, "108=20", 1, "10=98", 1
    >>,
    %?debugFmt("Message(r) == ~s", [M]),
    %?debugFmt("Message(e) == ~s", [M_expected]),
    %?debugFmt("Message(r) == ~w", [M]),
    %?debugFmt("Message(e) == ~w", [M_expected]),
